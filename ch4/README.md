...
3. **classification_without_labeled_data:** two opposite sentiment labels are embedded and the model indicates what movie review of the test dataset is similar to them using cosine similarity.
